...
class SceneCoordinator: SceneCoordinatorType {
    ...
    fileprivate var currentNavigationController: UINavigationController? {
        return (currentViewController as! UITabBarController).viewControllers![(currentViewController as! UITabBarController).selectedIndex] as? UINavigationController
    }
